...
RecordTarget[_a] = { fqn: "@aws-cdk/aws-route53.RecordTarget", version: "1.169.0" };
/**
 * A record set.
 */
...
RecordSet[_b] = { fqn: "@aws-cdk/aws-route53.RecordSet", version: "1.169.0" };
/**
...
AddressRecordTarget[_c] = { fqn: "@aws-cdk/aws-route53.AddressRecordTarget", version: "1.169.0" };
/**
 * A DNS A record
 *
...
ARecord[_d] = { fqn: "@aws-cdk/aws-route53.ARecord", version: "1.169.0" };
/**
 * A DNS AAAA record
 *
 * @resource AWS::Route53::RecordSet
...
AaaaRecord[_e] = { fqn: "@aws-cdk/aws-route53.AaaaRecord", version: "1.169.0" };
/**
 * A DNS CNAME record
 *
 * @resource AWS::Route53::RecordSet
...
CnameRecord[_f] = { fqn: "@aws-cdk/aws-route53.CnameRecord", version: "1.169.0" };
/**
 * A DNS TXT record
 *
 * @resource AWS::Route53::RecordSet
...
TxtRecord[_g] = { fqn: "@aws-cdk/aws-route53.TxtRecord", version: "1.169.0" };
/**
...
SrvRecord[_h] = { fqn: "@aws-cdk/aws-route53.SrvRecord", version: "1.169.0" };
/**
 * The CAA tag.
 */
var CaaTag;
...
CaaRecord[_j] = { fqn: "@aws-cdk/aws-route53.CaaRecord", version: "1.169.0" };
/**
...
CaaAmazonRecord[_k] = { fqn: "@aws-cdk/aws-route53.CaaAmazonRecord", version: "1.169.0" };
/**
 * A DNS MX record
 *
 * @resource AWS::Route53::RecordSet
...
MxRecord[_l] = { fqn: "@aws-cdk/aws-route53.MxRecord", version: "1.169.0" };
/**
 * A DNS NS record
 *
 * @resource AWS::Route53::RecordSet
...
NsRecord[_m] = { fqn: "@aws-cdk/aws-route53.NsRecord", version: "1.169.0" };
/**
 * A DNS DS record
 *
 * @resource AWS::Route53::RecordSet
...
DsRecord[_o] = { fqn: "@aws-cdk/aws-route53.DsRecord", version: "1.169.0" };
/**
...
ZoneDelegationRecord[_p] = { fqn: "@aws-cdk/aws-route53.ZoneDelegationRecord", version: "1.169.0" };
/**
...
CrossAccountZoneDelegationRecord[_q] = { fqn: "@aws-cdk/aws-route53.CrossAccountZoneDelegationRecord", version: "1.169.0" };
