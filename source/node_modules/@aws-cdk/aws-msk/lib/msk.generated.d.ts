...
export declare class CfnBatchScramSecret extends cdk.CfnResource implements cdk.IInspectable {
     ...
     * @internal
     */
    static _fromCloudFormation(scope: cdk.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnBatchScramSecret;
    /**
     * The Amazon Resource Name (ARN) of the MSK cluster.
     *
     * @link http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-msk-batchscramsecret.html#cfn-msk-batchscramsecret-clusterarn
     ...
     */
    constructor(scope: cdk.Construct, id: string, props: CfnBatchScramSecretProps);
    /**
...
export declare class CfnServerlessCluster extends cdk.CfnResource implements cdk.IInspectable {
     ...
     * @internal
     */
    static _fromCloudFormation(scope: cdk.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnServerlessCluster;
    /**
     *
     * @cloudformationAttribute Arn
     */
     ...
     * @param props - resource properties
     */
    constructor(scope: cdk.Construct, id: string, props: CfnServerlessClusterProps);
    /**
     * Examines the CloudFormation resource and discloses attributes.
     *
     * @param inspector - tree inspector to collect and process attributes
