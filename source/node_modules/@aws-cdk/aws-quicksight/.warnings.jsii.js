...
function _aws_cdk_aws_quicksight_CfnDataSet_TagColumnOperationProperty(p) {
    ...
    try {
        if (!visitedObjects.has(p.tags))
            _aws_cdk_aws_quicksight_CfnDataSet_ColumnTagProperty(p.tags);
    }
    finally {
        visitedObjects.delete(p);
    }
