...
class KeyCondition {
    ...
    and(keyCond) {
        try {
            jsiiDeprecationWarnings._aws_cdk_aws_appsync_KeyCondition(keyCond);
        }
        catch (error) {
...
KeyCondition[_a] = { fqn: "@aws-cdk/aws-appsync.KeyCondition", version: "1.169.0" };
/**
...
Assign[_b] = { fqn: "@aws-cdk/aws-appsync.Assign", version: "1.169.0" };
/**
...
PartitionKeyStep[_c] = { fqn: "@aws-cdk/aws-appsync.PartitionKeyStep", version: "1.169.0" };
/**
 * Utility class to allow assigning a value or an auto-generated id
 * to a sort key.
 */
class SortKeyStep {
    constructor(pkey, skey) {
        ...
        this.skey = skey;
        try {
            jsiiDeprecationWarnings._aws_cdk_aws_appsync_Assign(pkey);
        }
        catch (error) {
            if (process.env.JSII_DEBUG !== "1" && error.name === "DeprecationError") {
...
SortKeyStep[_d] = { fqn: "@aws-cdk/aws-appsync.SortKeyStep", version: "1.169.0" };
/**
...
class PrimaryKey {
    constructor(pkey, skey) {
        ...
        try {
            jsiiDeprecationWarnings._aws_cdk_aws_appsync_Assign(pkey);
            jsiiDeprecationWarnings._aws_cdk_aws_appsync_Assign(skey);
        }
        catch (error) {
            if (process.env.JSII_DEBUG !== "1" && error.name === "DeprecationError") {
...
PrimaryKey[_e] = { fqn: "@aws-cdk/aws-appsync.PrimaryKey", version: "1.169.0" };
/**
...
PartitionKey[_f] = { fqn: "@aws-cdk/aws-appsync.PartitionKey", version: "1.169.0" };
/**
...
AttributeValues[_g] = { fqn: "@aws-cdk/aws-appsync.AttributeValues", version: "1.169.0" };
/**
...
AttributeValuesStep[_h] = { fqn: "@aws-cdk/aws-appsync.AttributeValuesStep", version: "1.169.0" };
/**
