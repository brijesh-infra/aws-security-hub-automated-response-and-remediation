...
class MappingTemplate {
    ...
    static dynamoDbQuery(cond, indexName) {
        try {
            jsiiDeprecationWarnings._aws_cdk_aws_appsync_KeyCondition(cond);
        }
        catch (error) {
    ...
    static dynamoDbPutItem(key, values) {
        try {
            jsiiDeprecationWarnings._aws_cdk_aws_appsync_PrimaryKey(key);
            jsiiDeprecationWarnings._aws_cdk_aws_appsync_AttributeValues(values);
        }
        catch (error) {
            if (process.env.JSII_DEBUG !== "1" && error.name === "DeprecationError") {
...
MappingTemplate[_a] = { fqn: "@aws-cdk/aws-appsync.MappingTemplate", version: "1.169.0" };
