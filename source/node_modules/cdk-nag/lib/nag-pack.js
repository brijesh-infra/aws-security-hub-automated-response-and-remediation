...
class NagPack {
    ...
    writeToStackComplianceReport(params, ruleId, compliance, explanation = '') {
        ...
        const outDir = (_b = core_1.App.of(params.node)) === null || _b === void 0 ? void 0 : _b.outdir;
        const stackName = params.node.stack.nested
            ? core_1.Names.uniqueId(params.node.stack)
